...
class Settings_General {
	...
	public function __construct() {
		...
		$translations = array(
            __( 'All bookable', 'woocommerce-easy-booking-system' ),
            __( 'Number of dates', 'woocommerce-easy-booking-system' ),
            __( 'Booking mode', 'woocommerce-easy-booking-system' ),
            __( 'Booking duration', 'woocommerce-easy-booking-system' ),
            __( 'Booking min', 'woocommerce-easy-booking-system' ),
            __( 'Booking max', 'woocommerce-easy-booking-system' ),
            __( 'First available date', 'woocommerce-easy-booking-system' ),
            __( 'Last available date', 'woocommerce-easy-booking-system' )
        );
	...
	**/
	public function all_bookable() {
		...
		Settings::checkbox( array(
			...
			'description' => __( 'Make all your products bookable. If checked, any new or modified product will be automatically bookable.', 'woocommerce-easy-booking-system' ),
	...
	**/
	public function number_of_dates() {
		...
		Settings::select( array(
			...
			'description' => __( 'Number of dates to select. Customizable at product level.', 'woocommerce-easy-booking-system' ),
	...
	**/
	public function booking_mode() {
		...
		Settings::select( array(
			...
			'description' => __( 'Book your products by day or by night (i.e. 5 days = 4 nights).' , 'woocommerce-easy-booking-system' ),
			'options'     => array(
	...
	**/
	public function booking_duration() {
		...
		Settings::input( array(
			...
			'description'       => __( 'Booking duration in days/nights. Only for two dates selection. Customizable at product level.', 'woocommerce-easy-booking-system' ),
	...
	**/
	public function booking_min() {
		...
		Settings::input( array(
			...
			'description'       => __( 'Minimum number of booking duration(s) to select. Leave 0 or empty to set no minmum. Customizable at product level.', 'woocommerce-easy-booking-system' ),
			'custom_attributes' => array(
				'step' => '1',
                'min'  => '0',
                'max'  => '3650'
	...
	**/
	public function booking_max() {
		...
		Settings::input( array(
			...
			'description'       => __( 'Maximum number of booking duration(s) to select. Leave 0 or empty to set no maximum. Customizable at product level.', 'woocommerce-easy-booking-system' ),
			'custom_attributes' => array(
				'step' => '1',
                'min'  => '0',
                'max'  => '3650'
